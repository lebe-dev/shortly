...
helm upgrade --install -n shortly --create-namespace shortly tinyops/shortly --version 1.1.3

# with custom values
helm upgrade --install -n shortly --create-namespace shortly tinyops/shortly --version 1.1.3 -f values.yml
```
